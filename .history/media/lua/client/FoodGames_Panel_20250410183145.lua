...
function FoodGamesPanel:prerender()
    ...
    self.calData = self.player:getModData()['FoodGames']['consumedCalories']
    --self:drawTextureScaled(self.titlebarbkg, 2, 1, self:getWidth() - 4, th - 2, 1, 1, 1, 1);
    --self:drawRectBorder(0, 0, self.width, self.height, self.borderColor.a, self.borderColor.r, self.borderColor.g, self.borderColor.b);
    self:drawTextCentre(tostring(self.calData), self:getWidth() / 2, 32, 0.76, 0.59, 0.11, 1, UIFont.Large);
...
function FoodGamesPanel:OnSliderChange()
   ...
   --self.CalSlider:setCurrentValue(self.calData)
    self.player:getModData()['FoodGames']['consumedCalories']  = self.calData
    print(self.calData)
end
...
function FoodGamesPanel:new(x, y, width, height, player)
    ...
    o.backgroundColor = { r = 0.20, g = 0.20, b = 0.30, a = 1}--{ r = 0.12, g = 0.39, b = 0.77,  a = 1}
