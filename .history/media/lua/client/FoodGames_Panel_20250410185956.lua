...
function FoodGames.context(player, context, worldobjects, test)
	...
	if csq == sq then
        ...
        local optTip = context:addOptionOnTop("Open Food Games Panel, worldobjects, function()
        ...
        optTip.toolTip:setName(optTip:getName())
        tip.description = tostring(pl:getModData()['FoodGames']['consumedCalories'])
        optTip.toolTip = tip
